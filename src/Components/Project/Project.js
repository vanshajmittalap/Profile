      ...
      <div className="heading">
       ...
       <div className="container">
           <div className="row">
             ...
             <ProjectComponent pic={Project3} name={"E-DIARY"} description={"This is a FullStack Website. It has full functionality of User Authentication as Sign Up and Login. It stores data seperately for every users in my own created MongoDB server."} lk={'https://github.com/vanshajmittalap/E-DIARY'}/>
